...
class TtsService {
  ...
  Future<void> _speakWithPlatformTts({
    ...
    for (var index = 0; index < chunks.length; index++) {
      ...
      // ignore: avoid_print
      print('Detected Hindi: ${chunk.isHindi}');
      // ignore: avoid_print
      print('Selected TTS Language: ${chunk.languageCode}');
      // ignore: avoid_print
      print('Speaking Text: ${chunk.text}');
      // ignore: avoid_print
      print('Speech Rate: $speechRate');
      // ignore: avoid_print
      print('Speech Pitch: $speechPitch');
      await _setLanguageWithFallback(chunk.languageCode);
  ...
  Future<void> _setLanguageWithFallback(String languageCode) async {
    ...
    if (languageCode == _hindiLanguageCode) {
      debugPrint('TtsService: Hindi language unavailable; not falling back to an English voice');
      return;
    }
